...
install-importers:
	pip install ./gateway_pkg ./prestashop_pkg ./sellingo_pkg ./idosell_pkg ./magento_pkg ./shoper_pkg ./selly_pkg

develop-importers:
	pip install -e ./gateway_pkg
	pip install -e ./prestashop_pkg -e ./sellingo_pkg -e ./idosell_pkg -e ./magento_pkg -e ./shoper_pkg -e ./selly_pkg
